#include "FormColorDetect.h"
#include "ui_FormColorDetect.h"

FormColorDetect::FormColorDetect(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormColorDetect)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadColorDetect();
  dialog = new DialogColorDetect();
...
FormColorDetect::~FormColorDetect()
{
  delete ui;
}

void FormColorDetect::on_pushButton_nodeEnable_clicked()
{
...
void FormColorDetect::on_pushButton_prop_clicked()
{
