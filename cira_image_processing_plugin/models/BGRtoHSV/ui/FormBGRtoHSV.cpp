#include "FormBGRtoHSV.h"
#include "ui_FormBGRtoHSV.h"

FormBGRtoHSV::FormBGRtoHSV(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormBGRtoHSV)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadBGRtoHSV();
  dialog = new DialogBGRtoHSV();
...
FormBGRtoHSV::~FormBGRtoHSV()
{
  delete ui;
}

void FormBGRtoHSV::on_pushButton_nodeEnable_clicked()
{
...
void FormBGRtoHSV::on_pushButton_prop_clicked()
{
