#include "FormMatching.h"
#include "ui_FormMatching.h"

FormMatching::FormMatching(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormMatching)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadMatching();
  dialog = new DialogMatching();
...
FormMatching::~FormMatching()
{
  delete ui;
}

void FormMatching::on_pushButton_nodeEnable_clicked()
{
...
void FormMatching::on_pushButton_prop_clicked()
{
