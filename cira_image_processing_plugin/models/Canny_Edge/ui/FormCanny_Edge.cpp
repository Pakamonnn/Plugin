#include "FormCanny_Edge.h"
#include "ui_FormCanny_Edge.h"

FormCanny_Edge::FormCanny_Edge(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormCanny_Edge)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadCanny_Edge();
  dialog = new DialogCanny_Edge();
...
FormCanny_Edge::~FormCanny_Edge()
{
  delete ui;
}

void FormCanny_Edge::on_pushButton_nodeEnable_clicked()
{
...
void FormCanny_Edge::on_pushButton_prop_clicked()
{
