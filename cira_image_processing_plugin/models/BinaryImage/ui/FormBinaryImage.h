#ifndef FormBinaryImage_H
#define FormBinaryImage_H
...
#include "ThreadBinaryImage.hpp"
#include <cira_lib_bernoulli/general/GlobalData.hpp>
#include "popup/DialogBinaryImage.h"

namespace Ui {
class FormBinaryImage;
}

class FormBinaryImage : public QWidget
{
  Q_OBJECT

public:
  explicit FormBinaryImage(QWidget *parent = 0);
  ~FormBinaryImage();
  ...
  ThreadBinaryImage *workerThread;
  DialogBinaryImage *dialog;
...
private:
  Ui::FormBinaryImage *ui;
};

#endif // FormBinaryImage_H
