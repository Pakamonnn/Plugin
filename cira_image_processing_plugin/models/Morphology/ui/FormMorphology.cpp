...
FormMorphology::FormMorphology(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormMorphology)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadMorphology();
  dialog = new DialogMorphology();
...
FormMorphology::~FormMorphology()
{
  delete ui;
}

void FormMorphology::on_pushButton_nodeEnable_clicked()
{
...
void FormMorphology::on_pushButton_prop_clicked()
{
