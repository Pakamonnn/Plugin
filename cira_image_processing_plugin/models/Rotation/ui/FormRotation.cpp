#include "FormRotation.h"
#include "ui_FormRotation.h"

FormRotation::FormRotation(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormRotation)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadRotation();
  dialog = new DialogRotation();
...
void FormRotation::on_pushButton_nodeEnable_clicked()
{
...
void FormRotation::on_pushButton_prop_clicked()
{
