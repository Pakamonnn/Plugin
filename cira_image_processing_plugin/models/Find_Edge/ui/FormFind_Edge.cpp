#include "FormFind_Edge.h"
#include "ui_FormFind_Edge.h"

FormFind_Edge::FormFind_Edge(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormFind_Edge)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadFind_Edge();
  dialog = new DialogFind_Edge();
...
FormFind_Edge::~FormFind_Edge()
{
  delete ui;
}

void FormFind_Edge::on_pushButton_nodeEnable_clicked()
{
...
void FormFind_Edge::on_pushButton_prop_clicked()
{
