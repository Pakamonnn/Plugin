#include "FormGrayScale.h"
#include "ui_FormGrayScale.h"

FormGrayScale::FormGrayScale(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormGrayScale)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadGrayScale();
  dialog = new DialogGrayScale();
...
FormGrayScale::~FormGrayScale()
{
  delete ui;
}

void FormGrayScale::on_pushButton_nodeEnable_clicked()
{
...
void FormGrayScale::on_pushButton_prop_clicked()
{
