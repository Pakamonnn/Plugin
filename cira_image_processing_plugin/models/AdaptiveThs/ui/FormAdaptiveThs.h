#ifndef FormAdaptiveThs_H
#define FormAdaptiveThs_H
...
#include "ThreadAdaptiveThs.hpp"
#include <cira_lib_bernoulli/general/GlobalData.hpp>
#include "popup/DialogAdaptiveThs.h"

namespace Ui {
class FormAdaptiveThs;
}

class FormAdaptiveThs : public QWidget
{
  Q_OBJECT

public:
  explicit FormAdaptiveThs(QWidget *parent = 0);
  ~FormAdaptiveThs();
  ...
  ThreadAdaptiveThs *workerThread;
  DialogAdaptiveThs *dialog;
...
private:
  Ui::FormAdaptiveThs *ui;
};

#endif // FormAdaptiveThs_H
