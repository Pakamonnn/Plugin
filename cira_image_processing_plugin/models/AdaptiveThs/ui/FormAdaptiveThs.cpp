#include "FormAdaptiveThs.h"
#include "ui_FormAdaptiveThs.h"

FormAdaptiveThs::FormAdaptiveThs(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormAdaptiveThs)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadAdaptiveThs();
  dialog = new DialogAdaptiveThs();
...
FormAdaptiveThs::~FormAdaptiveThs()
{
  delete ui;
}

void FormAdaptiveThs::on_pushButton_nodeEnable_clicked()
{
...
void FormAdaptiveThs::on_pushButton_prop_clicked()
{
