#include "FormContours.h"
#include "ui_FormContours.h"

FormContours::FormContours(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::FormContours)
{
  ui->setupUi(this);
  ...
  workerThread = new ThreadContours();
  dialog = new DialogContours();
...
FormContours::~FormContours()
{
  delete ui;
}

void FormContours::on_pushButton_nodeEnable_clicked()
{
...
void FormContours::on_pushButton_prop_clicked()
{
#ifdef WIN32
