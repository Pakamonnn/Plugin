#ifndef DialogContours_H
#define DialogContours_H
...
namespace Ui {
class DialogContours;
}

class DialogContours : public QDialog
{
  Q_OBJECT

public:
  explicit DialogContours(QWidget *parent = 0);
  ~DialogContours();
...
private:
  Ui::DialogContours *ui;
};

#endif // DialogContours_H
